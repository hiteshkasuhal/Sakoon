...
$(document).on("click", 'a[href="#certificates"]', function (e) {
 e.preventDefault(); 
$('.popup_main').css('display','flex').addClass('active');
$('.popup_main').find('.slick-slider').slick('refresh');
});
...
$(document).on("click", ".CP_support_list1 .icons_with_text_flex .icons_with_text_item_text", function (e) {
$(this).toggleClass('active');
$(this).parents('.icons_with_text_item').find('.icons_with_text_item_title').slideToggle();
});



$(document).on("click", ".review_slider_tab", function (e) {
var data_tab = $(this).attr('data_tab');
$('.review_slider_tab').removeClass('active');
$(this).addClass('active');
$('.review_slider_tab_content').hide();
$('.review_slider_tab_content[data_tab="'+data_tab+'"]').show();
$('.review_slider_tab_content[data_tab="'+data_tab+'"]').find('.slick-slider').slick('refresh');
});
